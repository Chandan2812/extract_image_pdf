...
var PDFObjectCopier = /** @class */ (function () {
    function PDFObjectCopier(srcIndex, destIndex) {
        ...
        // prettier-ignore
        this.copy = function (object) { return (object instanceof pdf_structures_1.PDFPage ? _this.copyPDFPage(object)
            : object instanceof pdf_objects_1.PDFDictionary ? _this.copyPDFDict(object)
                : object instanceof pdf_objects_1.PDFArray ? _this.copyPDFArray(object)
                    : object instanceof pdf_objects_1.PDFStream ? _this.copyPDFStream(object)
                        : object instanceof pdf_objects_1.PDFIndirectReference ? _this.copyPDFIndirectObject(object)
                            : object.clone()); };
        this.copyPDFPage = function (originalPage) {
            ...
            clonedPage.Parent.ascend(function (parentNode) {
                pdf_structures_1.PDFPage.INHERITABLE_ENTRIES.forEach(function (key) {
